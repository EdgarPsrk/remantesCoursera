...
def pais():
    procedencia = input("Dime, ¿Cual es tu pais de origen?")
    return procedencia

def genero():
    sexo = input("¿Con que genero te identificas?")
    return sexo


def mostrar_perfil(nombre, edad, estatura_m, estatura_cm, num_amigos, pais, genero):
    print("--------------------------------------------------")
    print("Nombre:   ", nombre)
    print("Edad:     ", edad, "años")
    print("Estatura: ", estatura_m, "m y ", estatura_cm, "centímetros")
    print("Amigos:   ", num_amigos)
    print("Pais: Tu pasi es ", pais)
    print("Genero: Tu genero es ", genero)
    print("--------------------------------------------------")
...
mostrar_perfil(nombre, edad, estatura_m, estatura_cm, num_amigos, procedencia, sexo)
